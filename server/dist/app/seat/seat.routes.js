...
seatRouter.get("/:showId", restrictToAuthenticatedUser(), seatController.getSeatByShow.bind(seatController));
seatRouter.post("/lock", restrictToAuthenticatedUser(), seatController.lockSeats.bind(seatController));
